...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(fish-completion dockerfile-mode docker docker-tramp dired+ helpful cl-format doom-themes ox-hugo)
...
`dotspacemacs/user-config' first."
  ...
  (setq-default elfeed-search-filter "@2-week-ago +unread -databricks")
...
See `eshell-prompt-regexp'."
  ...
  (spacemacs/set-leader-keys "fF" #'counsel-git)
...
(defun kyo/kill-thing-at-point (thing)
...
(defun kyo/commafy-at-point (&optional thing)
  (interactive)
  (save-excursion
    (let* ((thing (if thing thing 'word))
           (num (thing-at-point thing t))
           (bounds (bounds-of-thing-at-point thing))
           (comma-num (save-excursion
                        (cl-format nil "~:d" (string-to-int num)))))
      (kill-region (car bounds) (cdr bounds))
      (insert comma-num))))
...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("d677ef584c6dfc0697901a44b885cc18e206f05114c8a3b7fde674fce6180879" "7666b079fc1493b74c1f0c5e6857f3cf0389696f2d9b8791c892c696ab4a9b64" "b5ecb5523d1a1e119dfed036e7921b4ba00ef95ac408b51d0cd1ca74870aeb14" "b81bfd85aed18e4341dbf4d461ed42d75ec78820a60ce86730fc17fc949389b2" default)))
 ...
 '(ledger-reports
   (quote
    ((#("budget" 0 1
        (idx 0))
      "ledger [[ledger-mode-flags]] -f /Users/sblumenthal/finances/ledger/main.ledger bal --budget")
     (#("bal" 0 1
        (idx 1))
      "ledger [[ledger-mode-flags]] -f /Users/sblumenthal/finances/ledger/main.ledger bal -V not equity")
     (#("reg" 0 1
        (idx 2))
      "ledger [[ledger-mode-flags]] -f /Users/sblumenthal/finances/ledger/main.ledger reg -V")
     (#("payee" 0 1
        (idx 3))
