...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(fish-completion dockerfile-mode docker docker-tramp)
...
See `eshell-prompt-regexp'."
  ...
  (add-hook 'eshell-mode-hook
            (lambda ()
              ...
              (define-key company-active-map 'company-complete-common-or-cycle nil)
              (company-mode 1)
